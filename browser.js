...
const ControlCamera = (function() {
  ...
  const { Quaternion, Vector3, PerspectiveCamera } = THREE;
...
const MovementCamera = (function() {
  ...
  return class MovementCamera extends ControlCamera {
