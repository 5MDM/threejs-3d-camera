...
var Three3DCamera = (() => {
  ...
  __export(browser_exports, {
    ControlCamera: () => ControlCamera2,
    MovementCamera: () => MovementCamera2
  });
  ...
  function newCamera(PerspectiveCamera, o) {
  ...
  function setQuaternion(Quaternion, Vector3, mathX, mathY) {
  ...
  function updateCamera({ Quaternion, Vector3 }, cam, mathX, mathY) {
  ...
  var ControlCamera = class {
     ...
     */
    loop() {
      updateCamera(__spreadValues({}, this.classes), this.camera, this.rx, this.ry);
     ...
     */
    setDefault(x, y) {
      updateCamera(__spreadValues({}, this.classes), this.camera, x, y);
      this.rx = x;
      this.ry = y;
      return this;
    }
  ...
  var MovementCamera = class extends ControlCamera {
    /**
    ...
    constructor(o, classes) {
       ...
       */
      __publicField(this, "direction", new this.classes.Vector3());
      /**
  ...
  var ControlCamera2 = class extends ControlCamera {
    /**
     * Creates a new ControlCamera instance with a new camera object
     * @param o - The options for the camera object
     * @param o.canvas - The canvas element to bind the camera to
     ...
     */
    constructor(o) {
      super(o, __spreadValues({}, window.THREE));
    }
  };
  var MovementCamera2 = class extends MovementCamera {
    /**
     * Creates a new MovementCamera instance with a new camera object
     * @param o - The options for the camera object
     * @param o.canvas - The canvas element to bind the camera to
