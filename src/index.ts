import {ControlCamera, MovementCamera, THREE} from "./types";
...
export default (function(
   ...
   */
  function setQuaternion(mathX: number, mathY: number): { qx: THREE.Quaternion, qz: THREE.Quaternion } {
   ...
   * @param mathY - The angle in radians for the z-axis rotation
   */
  function updateCamera(cam: THREE.PerspectiveCamera, mathX: number, mathY: number) {
  ...
  class ControlCamera {
     ...
     * @returns The current instance of ControlCamera
     */
    private setDefault (x: number, y: number): ControlCamera {
